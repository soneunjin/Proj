...
<script type="text/javascript">
        $(function(){
        	...
        	$('.pbtn').click(function(){
        		...
        		$('#frm').attr('action','/Project/qna/qnaSearch.cls');
    			$('#frm').submit();
        	});
	...
	<body>
				...
				<form method="post" action="" id="research">
					<input type="hidden" name="nowPage" id="nowPage" value="${param.nowPage}">
					<input type="hidden" name="sid" id="sid" value="${SID}">
					<input type="hidden" name="type"  id="resulttype">
					<input type="hidden" name="input" id="resultinput"> 
				</form>
					...
					<c:if test="${PAGE.startPage ge 4 }">
						...
						<div class="w3-col w-300" id="searchForm" >
							...
							<form method="post" action="" id="searchList">
								<input type="hidden" name="nowPage" id="nowPage" value="${param.nowPage}">
							<div class="w3-col m2">
								<select name="type" id="resel" style="margin: 10px;">
							...
							<div class="w3-col m4">
								<input id="resultinput" type="text" size="15" name="input" style="margin: 10px;" />
							</div>
							<div class="w3-col m2">
