...
<div id="wrapper">
				...
				<form method="post" action="" id="frm">
					<input type="hidden" name="nowPage" id="nowPage"
						...
						id="bno"><input type="hidden" name="tab" id="tab" value="${CAT}">
				</form>
				<form method="post" action="" id="frm">
				...
				<div>
					...
					<input class="ctagbtn" type="button" id="공지" value="공지"> <input
						class="ctagbtn" type="button" id="팁" value="팁"> <input
						class="ctagbtn" type="button" id="이벤트" value="이벤트">
					<div id="board">
						<table id="bList">
							<thred>
							<tr heigh="30">
