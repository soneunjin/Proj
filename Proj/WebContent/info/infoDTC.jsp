							...
							<!-- Banner -->
								<section id="banner">
									...
									<div class="detail" style="margin-left: -50px;">
											...
											<span style="font-size: 20px;"><b> 선별진료소 이름 : </b></span> <span style="font-size: 20px;" id="ctname"></span><br><br>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li><a href="/Project/info/infoDTC.cls">승차검진 진료소 정보</a></li>
												<!--
			...
			$(function(){
				...
				*/
				...
				$('.list').siblings().click(function(){
					...
					$.ajax({
						url: "/Project/ajax/infoDetail.dtc",
						type: 'POST',
						dataType: 'json',
						data:{
							"name":name
