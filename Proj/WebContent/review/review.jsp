...
<script type="text/javascript"
	src="/Project/assets/js/jquery-3.5.0.min.js"></script>
</head>
<script type="text/javascript">
	$(function(){
		$('.btn').click(function() {
...
<body class="is-preload">
	<form method="post" action="" id="frm">
		<input type="hidden" name="nowPage" id="nowPage"> <input
			type="hidden" name="rno" id="rno" value="">
	</form>
	<!-- Wrapper -->
	<div id="wrapper">
		<!-- Main -->
		<div id="main">
			<div class="inner">
				<!-- Header -->
				<header id="header">
					<a href="/Project/main.cls" class="logo"><strong>Editorial</strong>
						by HTML5 UP</a>
					...
					<c:if test="${not empty SID}">
						<div class="btn w3-col" id="logout">
							<b><span>SIGN OUT</span></b></a>
						</div>
					</c:if>
			</div>
			</header>
			<div class="mg30" style="padding-left: 20px;">
				<h4>
					<b>리뷰당</b>
				</h4>
			</div>
			...
			<div id="wrap">
				...
				<div id="board" style="max-width: 1000px; margin: 0 auto;">
					<c:forEach var="data" items="${LIST}">
						<div
							style="border: 1px solid rgb(78, 39, 39); margin: 10px; text-align: center;">
					...
					<div class="w3-center w3-margin">
						<div class="w3-bar w3-border">
							...
							<c:forEach var="pageNo" begin="${PAGE.startPage}"
								...
								<span
									class="w3-bar-item w3-border-left w3-button w3-hover-blue pgbtn pbtn">${pageNo}</span>
							</c:forEach>
							<c:if test="${PAGE.endPage ne PAGE.totalPage}">
								<span
									class="w3-bar-item w3-border-left w3-button w3-hover-blue pgbtn pbtn">NEXT</span>
							</c:if>
